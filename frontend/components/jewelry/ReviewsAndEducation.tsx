...
const reviews = [
    { id: 1, author: "Linda W.", product: "Diamond Stud Earrings", text: "These are my everyday essentials. The quality is stunning for the price.", src: "/review1.avif" },
    { id: 2, author: "James F.", product: "Gold Tennis Bracelet", text: "Bought this as a gift for our anniversary and she hasn't taken it off since.", src: "/review2.avif" },
    { id: 3, author: "Megan K.", product: "Pearl Strand Necklace", text: "Classic, elegant, and perfectly weighted. A true timeless piece.", src: "/review3.avif" },
]

const education = [
    { title: "Fine Jewelry Care", text: "Tips on how to keep your jewelry looking as brilliant as the day you bought it.", src: "/edu3.jfif" },
    { title: "Metal Guide", text: "Understand the differences between 14K, 18K gold and platinum.", src: "/edu4.jfif" },
]
            ...
            <div className="max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-12">
                <div className="mb-16 md:mb-24">
                    <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 md:mb-12 gap-4">
                        <h2 className="font-serif text-3xl md:text-[42px] text-gray-900 leading-tight">What Our Customers Say</h2>
