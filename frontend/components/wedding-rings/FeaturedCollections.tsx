...
const collections = [
    {
        title: "Best-Selling Wedding Bands",
        description: "Our most popular wedding settings. Each ring is crafted with precision to perfectly match your engagement ring.",
        href: "/wedding-rings/best-sellers",
        src: "/featured1.webp",
        alt: "Beautiful wedding bands"
    },
    {
        title: "Bridal Sets",
        description: "Expertly matched engagement and wedding rings designed to be worn together. Find your perfect pairing today.",
        href: "/wedding-rings/bridal-sets",
        src: "/featured2.webp",
        alt: "Bridal set showcase"
    },
    {
        title: "Alternative Metal Bands",
        description: "Modern and durable wedding bands for men and women in unique metals like tantalum and titanium.",
        href: "/wedding-rings/alternative-metals",
        src: "/featured3.webp",
        alt: "Unique metal wedding bands"
    }
]
