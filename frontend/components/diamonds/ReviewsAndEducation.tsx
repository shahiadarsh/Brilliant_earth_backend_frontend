...
const reviews = [
    { id: 1, author: "Michael T.", product: "1.2 ct Round Brilliant", text: "The sparkle is incredible. The grading report gave me total confidence in my purchase.", src: "/review1.avif" },
    { id: 2, author: "Sarah L.", product: "0.9 ct Lab Grown Oval", text: "I love that my diamond is lab-grown and sustainable. It's truly perfect.", src: "/review2.avif" },
    { id: 3, author: "Robert G.", product: "1.5 ct Cushion Cut", text: "The service was exceptional, and the diamond exceeded all expectations.", src: "/review3.avif" },
]

const education = [
    { title: "The 4Cs of Diamonds", text: "Learn how Cut, Color, Clarity, and Carat define a diamond's value.", src: "/edu1.jfif" },
    { title: "Natural vs Lab Grown", text: "Understand the differences and choose what's right for you.", src: "/edu5.jfif" },
]
            ...
            <div className="max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-12">
                <div className="mb-16 md:mb-24">
                    <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 md:mb-12 gap-4">
                        <h2 className="font-serif text-3xl md:text-[42px] text-gray-900 leading-tight">Diamond Customer Reviews</h2>
