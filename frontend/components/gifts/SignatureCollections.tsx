...
const collections = [
    { name: "Birthstone Collection", href: "/gemstones/birthstones", src: "/sign1.jfif" },
    { name: "Initial Collection", href: "/jewelry/personalized", src: "/sign2.jfif" },
    { name: "Diamond Essentials", href: "/jewelry/essentials", src: "/sign3.jfif" },
    { name: "Men's Gift Collection", href: "/jewelry/mens", src: "/sign4.jfif" },
    { name: "Classic Pearl Gifts", href: "/jewelry/pearls", src: "/sign5.jfif" },
]
        ...
        <section className="bg-white py-12 md:py-20 relative overflow-hidden">
            <div className="max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-12">
                <div className="mb-10 md:mb-16 text-center sm:text-left flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                    <div>
                        <h2 className="font-serif text-3xl md:text-4xl lg:text-[42px] text-gray-900 mb-2">Curated Gift Collections</h2>
                        <p className="font-sans text-sm md:text-base text-gray-500 max-w-lg">Hand-picked by our stylists, these collections offer a range of styles for every personality.</p>
                    </div>
                    <Link href="/collections" className="hidden sm:inline-block text-[11px] font-bold text-[#163E3E] uppercase tracking-[0.2em] border-b-2 border-[#163E3E]/20 hover:border-[#163E3E] transition-all pb-1 sm:mb-2">All Collections</Link>
                </div>
                ...
                <div className="w-full bg-[#052B23] overflow-hidden relative min-h-[400px] md:min-h-[500px] flex items-center rounded-sm">
                    ...
                    <div className="max-w-6xl mx-auto w-full px-8 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10 py-16">
                        <div className="relative h-64 w-64 mx-auto md:mx-0 md:h-[400px] md:w-full transition-transform duration-[2s] group-hover:scale-110">
                            <Image src="/gifts.jpg" alt="Gift Presentation" fill className="object-contain drop-shadow-[0_0_50px_rgba(255,255,255,0.4)]" />
                        </div>
                        <div className="text-center md:text-left flex flex-col items-center md:items-start text-white">
                            <p className="text-[10px] md:text-xs font-bold tracking-[0.4em] uppercase mb-4 opacity-70">Gifts of Love</p>
                            <h3 className="font-serif text-3xl md:text-4xl lg:text-5xl mb-6">Meaningful <span className="italic">Moments</span></h3>
                            <p className="text-sm md:text-base text-gray-200 leading-relaxed mb-10 max-w-sm opacity-80">Our mission is to help you celebrate every milestone with brilliance and integrity.</p>
                            <Link href="/about" className="bg-white text-[#052B23] text-[11px] font-bold uppercase tracking-widest px-12 py-4 hover:bg-[#163E3E] hover:text-white transition-all transform hover:scale-105">Our Impact</Link>
                        </div>
                    </div>
                </div>
            </div>
