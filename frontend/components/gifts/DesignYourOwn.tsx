...
const collections = [
    { name: "Birthstones", href: "/gemstones/birthstones", src: "/featured1.webp" },
    { name: "Initial Jewelry", href: "/jewelry/personalized", src: "/featured2.webp" },
    { name: "Engravable Pieces", href: "/jewelry/engravable", src: "/featured3.webp" },
    { name: "Custom Pendants", href: "/design/pendant", src: "/design4.jfif" },
]
            ...
            <div className="max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-12">
                ...
                <div className="w-full bg-[#163E3E] text-white overflow-hidden relative flex flex-col md:flex-row items-center justify-between py-10 px-8 md:py-12 md:px-16 gap-8 rounded-sm shadow-xl">
                    <div className="relative w-32 h-32 md:w-40 md:h-40 flex-shrink-0 z-10 order-2 md:order-1">
                        <Image src="/design5.webp" alt="Holiday Gift" fill className="object-cover rounded-full border-4 border-white/10 shadow-2xl" />
                    </div>
                    <div className="text-center md:text-left flex flex-col justify-center flex-1 z-10 order-1 md:order-2">
                        <p className="text-[10px] font-bold tracking-[0.3em] mb-3 uppercase text-white/70">Holiday Special</p>
                        <h3 className="text-xl md:text-2xl lg:text-3xl font-serif italic mb-4">Complimentary Gift Packaging <span className="block sm:inline font-sans not-italic text-sm md:text-lg opacity-80">With Every Order.</span></h3>
                        <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8">
                            <p className="text-xs md:text-sm tracking-[0.1em]">USE CODE <span className="font-bold text-lg inline-block ml-1">GOLDGIFT</span></p>
