    ...
    return (
        <div className="min-w-[260px] md:min-w-[280px] lg:min-w-[300px] flex flex-col group cursor-pointer">
            <div className="relative aspect-square bg-gray-50 mb-4 rounded-sm">
                {product.badge && (
                    <span className="absolute top-2 right-2 bg-white/95 px-2 py-1 text-[9px] font-bold tracking-widest uppercase text-gray-800 z-10 rounded-[2px] shadow-sm">
                        {product.badge}
                    </span>
                )}
        ...
        <section className="py-12 md:py-20 max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 relative bg-white overflow-hidden">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 md:mb-12 gap-4">
                <div className="text-center sm:text-left">
                    ...
                    <p className="text-gray-500 text-sm md:text-base">Our most-loved pieces, perfect for showing how much you care.</p>
                </div>
                <Link href="/gifts" className="hidden sm:inline-block text-[11px] font-bold text-[#163E3E] uppercase tracking-[0.2em] border-b-2 border-[#163E3E]/20 hover:border-[#163E3E] transition-all pb-1">
                    View All Gifts
                </Link>
            </div>
