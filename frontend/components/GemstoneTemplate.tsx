...
export default function GemstoneTemplate({
    title,
    description,
    products,
    filterTabs,
    ...
    const filteredProducts = products.filter(product =>
        product.category === activeFilter || product.type === activeFilter || activeFilter === filterTabs[0]
    )
            ...
            <div className="border-b border-gray-200">
                <div className="max-w-[1400px] mx-auto px-6 py-4">
                    <nav className="flex items-center gap-2 text-[13px] text-gray-600">
                        ...
                        <span>/</span>
                        <Link href="/gemstones" className="hover:text-gray-900">Gemstones</Link>
                        {section && (
                            <>
                                <span>/</span>
