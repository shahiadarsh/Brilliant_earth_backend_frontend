            ...
            <div className="max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-12">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                    <div className="relative aspect-[16/10] sm:aspect-video lg:aspect-square xl:aspect-[16/10] w-full overflow-hidden rounded-sm shadow-2xl group order-1 lg:order-2">
                        <Image src="/showroom.jfif" alt="Showroom" fill className="object-cover transition-transform duration-[2s] group-hover:scale-110" priority />
                    </div>
                    <div className="flex flex-col items-center lg:items-start max-w-2xl mx-auto lg:mx-0 order-2 lg:order-1 text-center lg:text-left">
                        <p className="text-[10px] b-6 uppercase tracking-[0.4em] text-gray-400 font-bold mb-6">Personalized Service</p>
                        <h2 className="font-serif text-3xl md:text-5xl lg:text-6xl text-gray-900 mb-8 leading-[1.1] tracking-wide">Find Your Sparkle <br /> <span className="italic">In Person or Online</span></h2>
                        <p className="font-sans text-sm md:text-base lg:text-lg text-gray-600 mb-12 leading-relaxed max-w-lg">Our experts are ready to help you find the perfect gemstone in one of our stunning showrooms.</p>
